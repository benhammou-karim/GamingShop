            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Ajouter Categorie</h1>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                            	...
                            	<form name="sendcate" method="POST" action="../PHP_req/add_cate.php" >
					                <table>
					                    <tr>
					                        <td><label for='title'>Categorie name:</label></td>

					                        <td><input type="text" placeholder="title" id='titleCate' name='titleCate'></td>
					                    </tr>
					                </table>
					                <br/></br>
					                ...
					                <?php
					                    ...
					                    if (isset($_GET['erreurcate'])){
					                        echo '<font color="red">'.$_GET['erreurcate'].'</font>';
					                        echo '<br>';
					                    }
					                    if (isset($_GET['validercate'])){
					                        echo '<font color="green">'.$_GET['validercate'].'</font>';
					                        echo '<br>';
					                    }
					                ?>
					            </form>
