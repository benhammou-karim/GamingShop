                ...
                <main>
                    <div class="container-fluid">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <form name="test" method="POST" action="../PHP_req/add_prod.php" >
					                <table>
					                    <tr>
					                    ...
					                    <tr>
					                        ...
					                        <td><input type="text" placeholder="$$" id='price' name='price'/></td>
					                    </tr>

					                    <tr>
					                        <td><label for='nom'>Image url:</label></td>

					                        <td><input type="text" placeholder="!! url only !!" id='image' name='image'/></td>
					                    </tr>
					                        
					                    <td>
					                        <label for='descrition'>Description:</label></td>

					                        <td><textarea cols="30" rows="4" name="description" id="description"></textarea><br></td>
					                    </tr>

					                    <tr><td><label for='nom'>Catégorie:</label></td>
					                ...
					                <?php
					                    if (isset($_GET['erreuraddprod'])){
					                        echo '<font color="red">'.$_GET['erreuraddprod'].'</font>';
					                        echo '<br>';
					                    }
					                    if (isset($_GET['valideraddprod'])){
					                        echo '<font color="green">'.$_GET['valideraddprod'].'</font>';
					                        echo '<br>';
					                    }
					                ?>
            					</form>
