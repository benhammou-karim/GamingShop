            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Ajouter Utilisateur</h1>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <form name="test" method="POST" action="../PHP_req/add_Cli.php" >
                                    <table>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" placeholder="code_postal" id='code_postal' name='code_postal'/></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" placeholder="Telephone" id='tel' name='tel'/></td>
                                        </tr>
                                        <tr>   
                                        <td>
                                            <label for='mail'>mail:</label></td>

                                            <td><input type="text" placeholder="mail" id='mail' name='mail'/></td>
                                        </tr>
                                        <tr>   
                                        <td>
                                    ...
                                    <?php
                                        if (isset($_GET['erreuraddcli'])){
                                            echo '<font color="red">'.$_GET['erreuraddcli'].'</font>';
                                            echo '<br>';
                                        }
                                        if (isset($_GET['valideraddcli'])){
                                            echo '<font color="green">'.$_GET['valideraddcli'].'</font>';
                                            echo '<br>';
                                        }
                                    ?>
                                </form>
