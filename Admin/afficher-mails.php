            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Afficher Mails</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="afficher-utilisateurs.php">Mails</a></li>
                            <li class="breadcrumb-item active">afficher Mails</li>
                        </ol>
                        <div class="card mb-4">
